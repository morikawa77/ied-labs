...
public class EmpregadoHorista extends Empregado
{
   ...
   public double setSalarioPorHora()
   {
   ...
   {                                                                   
      if ( getQtdHorasSemanais() <= 40 ) // nenhuma hora extra                           
         return setSalarioPorHora() * getQtdHorasSemanais();                                
      else                                                             
         return 40 * setSalarioPorHora() + ( getQtdHorasSemanais() - 40 ) * setSalarioPorHora() * 1.5;
   ...
   {                                                                     
      return String.format( "Empregado horista: %s\n%s: $%,.2f; %s: %,.2f",
         super.toString(), "Salário por hora", setSalarioPorHora(),                     
